 ...
 */
public class QueryUserAndAdminParamBean {
    ...
    private String departCondition = null;
    private String groupCondition = null;
    private String telphoneCondition = null;
    ...
    public String getDepartCondition() {
        return departCondition;
    }

    public void setDepartCondition(String departCondition) {
        this.departCondition = departCondition;
    }
    ...
    public String getTelphoneCondition() {
        return telphoneCondition;
    }

    public void setTelphoneCondition(String telphoneCondition) {
        this.telphoneCondition = telphoneCondition;
    }
}
