...
<script type="text/javascript">
    ...
    function submitAddDevForm(){
         if(!checkAddUserAndAdminFormBeforeSubmit()){
            return;
        }
        $.ajax({
            url:"<%=request.getContextPath()%>/dev/saveAddDev.do",
...
<div style="width: 450px;margin: 0 auto;">
    <form id="addDevForm">
        ...
        <table cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <input id="buildType" class="easyui-combobox" name="buildType" style="width:260px"
                           data-options="url:'<%=request.getContextPath()%>/data/buildType_data.json',
            ...
            <tr>
                ...
                <td>
                    <input id="operationGroup" class="easyui-combobox" name="operationGroup" style="width:260px"
            ...
            <tr>
                ...
                <td>
                    <input id="operationDepart" name="operationDepart" class="easyui-combobox" style="width:260px"
            ...
            <tr>
                ...
                <td>
                    <input id="machineRoom" name="machineRoom" class="easyui-combobox" style="width:260px"
            ...
            <tr>
                ...
                <td>
                    <input id="devType" name="devType" class="easyui-combobox" style="width:260px"
                           data-options="url:'<%=request.getContextPath()%>/data/devType_data.json',
                           prompt:'设备类型',valueField:'id',textField:'text',panelHeight:'auto'" />
                </td>
            </tr>
            <tr>
                <td style="text-align: right">设备型号:<span style="color:red">*</span></td>
                <td>
                    <input id="devModel" name="devModel" class="easyui-combobox" style="width:260px"
                           data-options="url:'<%=request.getContextPath()%>/data/devModel_data.json',
                           prompt:'设备型号',valueField:'id',textField:'text'" />
                </td>
            </tr>
            <tr>
                <td style="text-align: right">品牌:<span style="color:red">*</span></td>
                <td>
                    <input id="brand" name="brand" class="easyui-combobox" style="width:260px"
    ...
    <div style="text-align:center;padding:5px">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="submitAddDevForm()">保存</a>
    </div>
</div>