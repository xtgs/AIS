...
<script type="text/javascript">
    ...
    function checkAddItemBeforeSubmit(){
    ...
    function submitAddItemForm() {
         if(!checkAddItemBeforeSubmit()){
            return;
         }
        $.ajax({
            url:"<%=request.getContextPath()%>/item/insert.do"+
...
<div  style="width: 400px;margin: 0 auto;">
            ...
            <tr>
                <td colspan="2" >
                    <div class="formTitle" style="background-color:#f2f2f2;">
                        ...
                        </div><div class="formTitle-text" style="font-weight:bold;text-decoration:none;font-style:normal;text-align:left;">新增项目信息</div>
                    </div>
                </td>
            </tr>
    ...
    <div style="text-align:center;padding:5px">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="submitAddItemForm()">保存</a>
    </div>
</div>
